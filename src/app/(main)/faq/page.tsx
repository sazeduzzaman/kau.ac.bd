...
const faqData = [
  {
    category: "Admissions & Academic",
    icon: FaGraduationCap,
    questions: [
      {
        q: "What are the minimum eligibility criteria for undergraduate programs?",
        a: "Applicants must have passed HSC/Alim or equivalent exams...",
      },
      {
        q: "How can I access my semester results?",
        a: "Results are published online on the official Academic Results portal...",
      },
      {
        q: "Can I change my faculty or major after admission?",
        a: "Faculty change requests are handled by the Academic Council...",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "Are there on-campus dormitory facilities available?",
        a: "Yes, KAU provides separate dormitory facilities...",
      },
      {
        q: "What are the library hours?",
        a: "The Central Library is generally open from 9:00 AM to 8:00 PM...",
      },
    ],
  },
];
...
const FAQPage: React.FC = () => {
  ...
  // Always open first question by default
  ...
  const toggleAccordion = (index: number) => {
    setOpenIndex(index); // always open the clicked item, closes others automatically
  };
          ...
          <div className="sticky p-6 border border-gray-200 shadow-lg top-10 bg-gray-50 rounded-xl">
            ...
            <nav className="space-y-2">
              {faqData.map((category) => (
                ...
                >
                  <category.icon className="w-5 h-5 mr-3 text-sky-500" />
