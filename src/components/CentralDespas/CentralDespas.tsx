...
// Sample data
const centralDespasData: Section[] = [
  {
    id: "admin-1",
    ...
    officers: [
      {
        ...
        phone: "+880 1750 351984",
        email: "masudranakau@gmail.com",
...
export default function CentralDespas() {
  // Extract officers
  const officers = centralDespasData[0]?.officers || [];
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl py-10 mx-auto text-center">
          <div className="inline-flex items-center justify-center p-3 mb-6 rounded-full bg-site-primary backdrop-blur-sm">
            <FaAngleDoubleDown className="w-8 h-8 text-white" />
          </div>
          <h1 className="mb-6 text-3xl font-bold md:text-5xl">
            Central Despas
          </h1>
          <p className="max-w-3xl mx-auto text-lg leading-relaxed capitalize md:text-xl">
            The Central Despas coordinates administrative tasks across
            departments, ensuring smooth operations and effective communication.
          </p>
        </div>
      </div>
