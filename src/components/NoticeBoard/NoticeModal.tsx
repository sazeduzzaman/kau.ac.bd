...
import { X, Calendar, FileText, Download, FileType, ExternalLink } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6 md:p-8">
          ...
          <div className="p-6 border bg-emerald-50 rounded-xl border-emerald-100">
            ...
            <div className="flex flex-col gap-3">
              <button className="flex items-center justify-between p-4 transition-all bg-white border rounded-lg border-emerald-100 hover:border-emerald-300 hover:shadow-md group">
        ...
        <div className="sticky bottom-0 flex justify-end gap-3 p-6 border-t border-gray-100 bg-gray-50">
          ...
          <button className="px-5 py-2.5 rounded-lg bg-emerald-600 text-white font-medium hover:bg-emerald-700 shadow-md hover:shadow-lg transition-all">
            Download File
          </button>
        </div>
      </div>
